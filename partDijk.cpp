...
double **PartDijk::getDistMap(bool isLoad)
{
    return isLoad ? loadedDist : unloadDist;
}

void PartDijk::fillDist(double fill, bool isLoad)
{
...
bool PartDijk::validCoord(int r, int c)
{
    // 检查位置是否合法
...
std::list<Vec *> *PartDijk::getKnee(int r, int c, bool isLoad)
{
